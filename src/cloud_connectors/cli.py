"""Unified CLI for Cloud Connectors.

This module provides a command-line interface to all cloud connectors
using the central registry for discovery.

Usage:
    # List connector catalog entries
    cloud-connectors list
    cloud-connectors list --category cloud
    cloud-connectors list --capability repositories

    # Call any connector data method
    cloud-connectors call <connector> <method> [--arg value ...]
...
def cmd_mcp(args: argparse.Namespace) -> int:
    """Start MCP server."""
    from cloud_connectors.mcp import main as mcp_main
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        prog="cloud-connectors",
        description="Unified CLI for all cloud connectors",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  cloud-connectors list                    # List connector catalog entries
  cloud-connectors list --category cloud   # List cloud connectors
  cloud-connectors list --capability files # List connectors by capability
  cloud-connectors methods jules           # List Jules data methods
  cloud-connectors call jules list_sources # Call a method
  cloud-connectors call cursor list_agents
  cloud-connectors mcp                     # Start MCP server
        """,
    )
