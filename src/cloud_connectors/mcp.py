"""Unified MCP Server for Cloud Connectors.
...
Usage:
    # Command line
    cloud-connectors-mcp

    # Or programmatically
    from cloud_connectors.mcp import create_server, main
...
from cloud_connectors.surface import connector_data_methods
...
def create_server() -> Any:
    ...
    try:
        ...
        msg = "MCP SDK not installed. Install with: pip install cloud-connectors[mcp]"
        raise ImportError(msg) from e

    server = Server("cloud-connectors")
