...
from cloud_connectors.github._diagnostics import safe_github_ref, safe_github_text
...
def _load_github_sdk() -> None:
    ...
    if needs_github_module or needs_exceptions or needs_graphql:
        try:
            ...
            msg = "PyGithub is required for GitHubConnector. Install with: pip install cloud-connectors[github]"
...
from cloud_connectors.github.tools import (
    get_crewai_tools,
    get_langchain_tools,
    get_strands_tools,
    get_tools,
