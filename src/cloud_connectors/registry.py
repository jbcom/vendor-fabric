...
This module provides automatic discovery and registration of cloud connectors
...
Usage:
    from cloud_connectors.registry import get_connector, list_available_connectors, list_connectors
...
Entry Points (in pyproject.toml):
    [project.entry-points."cloud_connectors.connectors"]
    jules = "cloud_connectors.google.jules:JulesConnector"
    cursor = "cloud_connectors.cursor:CursorConnector"
    github = "cloud_connectors.github:GitHubConnector"
"""
...
from cloud_connectors._optional import (
...
class BuiltinConnectorAdapter(ConnectorAdapter):
    ...
    def install(self) -> str:
        ...
        return str(install or f"pip install cloud-connectors[{self.spec.extra}]")
...
def _discover_connectors() -> dict[str, builtins.type[ConnectorBase]]:
    ...
    eps = entry_points(group="cloud_connectors.connectors")
...
def _raise_unregistered_builtin_connector(name: str) -> NoReturn:
    ...
    raise RuntimeError(
        ...
        "cloud_connectors entry point group. "
