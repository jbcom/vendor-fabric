"""ConnectorFabric - cached connector access for cloud connectors."""
...
class ConnectorFabric(InputProvider):
    """Public API for cloud connectors with client caching.
    ...
    For Meshy AI, use the functional interface directly:
        from cloud_connectors.meshy import text3d, image3d, rigging, animate
    ...
    def get_aws_connector(
        ...
        Requires: pip install cloud-connectors[aws]
        """
    ...
    def get_github_client(
        ...
        Requires: pip install cloud-connectors[github]
        """
    ...
    def get_google_client(
        ...
        Requires: pip install cloud-connectors[google]
        """
    ...
    def get_slack_client(
        ...
        Requires: pip install cloud-connectors[slack]
        """
    ...
    def get_vault_client(
        ...
        Requires: pip install cloud-connectors[vault]
        """
