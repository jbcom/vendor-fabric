...
Usage:
    # Command line
    python -m vendor_fabric.meshy.mcp
...
Configure in Claude Desktop (~/Library/Application Support/Claude/claude_desktop_config.json):
    {
      "mcpServers": {
        "meshy": {
          "command": "python",
          "args": ["-m", "vendor_fabric.meshy.mcp"],
          "env": {
...
MCP_INSTALL_MESSAGE = "MCP SDK not installed. Install with: pip install vendor-fabric[meshy,mcp]"
...
def _create_mcp_tools() -> list[tuple[Any, Callable[..., Any]]]:
    ...
    from vendor_fabric.meshy import tools
