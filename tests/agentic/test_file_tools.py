...
class TestGetWorkspaceRoot:
    ...
    def test_uses_target_package_env_var(self, temp_workspace: Path) -> None:
        ...
        from vendor_fabric.agentic.tools.file_tools import get_workspace_root
        ...
        with (
            ...
            patch(
                "vendor_fabric.agentic.tools.file_tools._find_workspace_root",
...
class TestGameCodeWriterTool:
    ...
    def test_rejects_path_traversal(self) -> None:
        ...
        from vendor_fabric.agentic.tools.file_tools import GameCodeWriterTool
    ...
    def test_writes_to_allowed_directory(self, temp_workspace: Path) -> None:
        ...
        with patch(
            "vendor_fabric.agentic.tools.file_tools.get_workspace_root",
...
class TestGameCodeReaderTool:
    ...
    def test_rejects_path_traversal(self) -> None:
        """Test that path traversal is rejected."""
        from vendor_fabric.agentic.tools.file_tools import GameCodeReaderTool
...
class TestDirectoryListTool:
    ...
    def test_lists_directory_contents(self, temp_workspace: Path) -> None:
        ...
        from vendor_fabric.agentic.tools.file_tools import DirectoryListTool
