...
class AWSConnector(AWSOrganizationsMixin, AWSSSOmixin, AWSS3Mixin, ConnectorBase):
    ...
    @capability("get_secret", kind="secrets", description="Read one AWS Secrets Manager secret.")
    def get_secret(
        self,
        secret_id: str,
        execution_role_arn: str | None = None,
    ...
    @capability("list_secrets", kind="secrets", description="List AWS Secrets Manager secrets.")
    def list_secrets(
        self,
    ...
    @capability("create_secret", kind="secrets", description="Create an AWS Secrets Manager secret.")
    def create_secret(
        self,
        name: str,
        secret_value: str,
    ...
    @capability("write_secret", kind="secrets", aliases=("update_secret",), description="Update an AWS secret value.")
    def update_secret(
        self,
        secret_id: str,
        secret_value: str,
    ...
    @capability("delete_secret", kind="secrets", description="Delete an AWS Secrets Manager secret.")
    def delete_secret(
        self,
        secret_id: str,
