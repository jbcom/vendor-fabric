...
class AWSS3Mixin:
    ...
    @capability("list_buckets", kind="files", aliases=("list_filesystems",), description="List S3 buckets.")
    def list_s3_buckets(
        self,
    ...
    @capability("get_file", kind="files", aliases=("read_file",), description="Read an S3 object.")
    def get_object(
        self,
        bucket: str,
        key: str,
    ...
    @capability("decode_file", kind="files", description="Read and decode a JSON S3 object.")
    def get_json_object(
        self,
        bucket: str,
        key: str,
    ...
    @capability("put_file", kind="files", aliases=("write_file",), description="Write an S3 object.")
    def put_object(
        self,
        bucket: str,
        key: str,
    ...
    @capability("list_files", kind="files", description="List S3 objects.")
    def list_objects(
        self,
        bucket: str,
