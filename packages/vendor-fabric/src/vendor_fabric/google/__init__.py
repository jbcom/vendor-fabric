...
def _load_google_sdk() -> None:
    ...
    if service_account is None or build is None:
        try:
            ...
            msg = "google-api-python-client is required for GoogleConnector. Install with: pip install vendor-fabric[google]"
...
from vendor_fabric.google.constants import (
    DEFAULT_DOMAIN,
    DEFAULT_USER_OUS,
    GCP_KMS,
    GCP_REQUIRED_APIS,
...
from vendor_fabric.google.jules import (
    JulesConnector,
    JulesError,
    Session,
    SessionState,
