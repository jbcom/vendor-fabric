...
PAYLOAD_METHODS = (
    ...
    (MeshyConnector.text2image_generate, ExtendedDict | ExtendedString),
    (MeshyConnector.image2image_generate, ExtendedDict | ExtendedString),
    (MeshyConnector.image3d_generate, ExtendedDict | ExtendedString),
    (MeshyConnector.multiimage3d_generate, ExtendedDict | ExtendedString),
    (MeshyConnector.remesh_model, ExtendedDict | ExtendedString),
